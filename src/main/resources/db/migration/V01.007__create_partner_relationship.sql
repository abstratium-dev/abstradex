...
CREATE TABLE T_partner_relationship (
    ...
    CONSTRAINT chk_partner_rel_type CHECK (relationship_type IN ('PARENT_COMPANY', 'SUBSIDIARY', 'EMPLOYEE', 'AUTHORIZED_REP', 'BUSINESS_PARTNER', 'REFERRAL', 'AFFILIATED', 'OTHER')),
...
CREATE INDEX idx_partner_rel_type ON T_partner_relationship(relationship_type);
