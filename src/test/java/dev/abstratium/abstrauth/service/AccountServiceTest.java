...
public class AccountServiceTest {
    ...
    private void ensureClientExists(String clientId) {
        var query = em.createQuery("SELECT c FROM OAuthClient c WHERE c.clientId = :clientId", dev.abstratium.demo.entity.OAuthClient.class);
    ...
    public void testCreateAccountSuccess() {
        ...
        Optional<Demo> credential = accountService.findCredentialByUsername(username);
    ...
    public void testFailedAttemptsResetOnSuccessfulLogin() {
        ...
        Optional<Demo> credentialBefore = accountService.findCredentialByUsername(username);
        ...
        Optional<Demo> credentialAfter = accountService.findCredentialByUsername(username);
    ...
    public void testFindCredentialByAccountId() {
        ...
        Optional<Demo> credential = accountService.findCredentialByAccountId(account.getId());
    ...
    public void testCannotDeleteAccountWithOnlyAdminRole() throws Exception {
        ...
        var existingAdmins = em.createQuery(
            ...
            dev.abstratium.demo.entity.AccountRole.class
        );
