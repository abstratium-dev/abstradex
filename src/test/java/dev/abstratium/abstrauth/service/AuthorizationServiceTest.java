...
import dev.abstratium.demo.service.AuthorizationService;
...
public class AuthorizationServiceTest {
    ...
    public void setup() throws Exception {
        ...
        var clientQuery = em.createQuery("SELECT c FROM OAuthClient c WHERE c.clientId = 'test_client'", dev.abstratium.demo.entity.OAuthClient.class);
    ...
    public void testApproveExpiredRequest() throws Exception {
        ...
        assertThrows(dev.abstratium.demo.boundary.TimedOutException.class, () -> {
