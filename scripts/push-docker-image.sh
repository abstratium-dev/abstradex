...
docker push ghcr.io/abstratium-dev/abstradex:$VERSION
docker push ghcr.io/abstratium-dev/abstradex:latest
...
echo "  - ghcr.io/abstratium-dev/abstradex:$VERSION"
echo "  - ghcr.io/abstratium-dev/abstradex:latest"
